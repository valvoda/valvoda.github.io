...
title: about
permalink: /
subtitle: '<a href="https://deepmind.google/">Research at Google DeepMind</a>'
...
I have research experience in industry ([Google](https://deepmind.google/), [Amazon](https://www.amazon.science/){:target="\_blank"}, [Apple](https://machinelearning.apple.com/){:target="\_blank"}) and academia ([University of Cambridge](https://www.cl.cam.ac.uk/research/nl/people/){:target="\_blank"}, [ETH Zurich](https://ai.ethz.ch/){:target="\_blank"}, [University of Copenhagen](https://di.ku.dk/english/research/p1ai/){:target="\_blank"}, [NII](https://www.nii.ac.jp/en/){:target="\_blank"}).
